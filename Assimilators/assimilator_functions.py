...
app_specific_dict = {'ffmpeg_encoder': {'wu_get': generic_wu_basename_select,
                     ...
                     'opus_encoder': {'wu_get': generic_wu_basename_select,
                                      'assimilator': generic_assimilator, },
                     'paq8px_v185': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v186': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v186fix1': {'wu_get': generic_wu_basename_select,
                                         'assimilator': generic_assimilator, },
                     'paq8px_v187': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v187fix3': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v187fix5': {'wu_get': generic_wu_basename_select,
                                         'assimilator': generic_assimilator, },
                     'paq8px_v188': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v189': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v193fix2': {'wu_get': generic_wu_basename_select,
                                         'assimilator': generic_assimilator, },
                     'paq8px_v198': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v201': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v202': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v203': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8px_v204': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
                     'paq8pxd_v85': {'wu_get': generic_wu_basename_select,
                                     'assimilator': generic_assimilator, },
